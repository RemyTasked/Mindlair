...
import { X, Quote, Loader2, ChevronDown } from 'lucide-react';
...
export function AnnotationComposer({
  ...
  return (
    <Sheet
      open={isOpen}
      onClose={onClose}
      variant={isNarrow ? 'bottom' : 'modal'}
      snapPoints={isNarrow ? [0.7] : undefined}
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            &quot;{isNarrow && !isQuoteExpanded ? truncatedText : selection.text}&quot;
          </p>
          {isNarrow && (
            <ChevronDown
              size={16}
