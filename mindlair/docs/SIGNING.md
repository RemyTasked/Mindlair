...
This document explains how to set up code signing for Mindlair desktop releases.
...
npx @tauri-apps/cli signer generate -w ~/.tauri/mindlair.key

# This creates:
# - ~/.tauri/mindlair.key (private key - keep secure!)
# - ~/.tauri/mindlair.key.pub (public key - add to tauri.conf.json)
```
...
2. Generate a new password for "Mindlair CI"
...
```json
{
  ...
  "platforms": {
    "darwin-aarch64": {
      "signature": "...",
      "url": "https://releases.example.com/Mindlair_0.2.0_aarch64.dmg"
    }
  }
}
```
