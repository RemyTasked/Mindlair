...
const FLOWS = {
  'pre-meeting-focus': {
    ...
    steps: [
      { id: 'intro', type: 'intro' as const, duration: 10, text: "Let's take 2 minutes to prepare for this meeting.", guidance: "Find a comfortable position. You're about to step into an important moment.", animation: 'fade' as const },
      { id: 'breathing-1', type: 'breathing' as const, duration: 32, text: 'Box Breathing', guidance: 'Breathe in for 4... hold for 4... breathe out for 4... hold for 4.', animation: 'breathe' as const },
      { id: 'body-scan', type: 'body-scan' as const, duration: 30, text: 'Quick Body Scan', guidance: 'Notice any tension in your shoulders, jaw, or hands. Let it soften.', animation: 'pulse' as const },
      { id: 'breathing-2', type: 'breathing' as const, duration: 32, text: 'Continue Breathing', guidance: 'One more round. In... hold... out... hold.', animation: 'breathe' as const },
      { id: 'intention', type: 'visualization' as const, duration: 10, text: 'Set Your Intention', guidance: "What's your focus for this meeting? Hold that intention clearly.", animation: 'expand' as const },
      { id: 'closing', type: 'closing' as const, duration: 6, text: "You're ready.", guidance: 'Enter your meeting with confidence.', animation: 'fade' as const },
    ],
  },
  ...
  'quick-reset': {
    ...
    steps: [
      { id: 'intro', type: 'intro' as const, duration: 5, text: 'Quick reset in 90 seconds.', guidance: 'Stand up if you can.', animation: 'fade' as const },
      { id: 'shake-out', type: 'movement' as const, duration: 20, text: 'Shake It Out', guidance: 'Shake your hands, arms, shoulders. Let go of the last meeting.', animation: 'pulse' as const },
      { id: 'breathing', type: 'breathing' as const, duration: 36, text: 'Cleansing Breaths', guidance: 'Deep breath in through nose... long exhale through mouth. Three cycles.', animation: 'breathe' as const },
      { id: 'mental-clear', type: 'visualization' as const, duration: 20, text: 'Clear Your Mind', guidance: "Imagine a gentle breeze clearing away thoughts. You're in the present now.", animation: 'expand' as const },
      { id: 'closing', type: 'closing' as const, duration: 9, text: 'Reset complete. Fresh start.', guidance: "You're ready for what's next.", animation: 'fade' as const },
    ],
  },
  ...
  'breathing': {
    ...
    steps: [
      { id: 'intro', type: 'intro' as const, duration: 5, text: 'Take a moment to breathe.', guidance: 'Find a comfortable position.', animation: 'fade' as const },
      { id: 'breathing', type: 'breathing' as const, duration: 48, text: 'Box Breathing', guidance: 'Breathe in for 4... hold for 4... breathe out for 4... hold for 4.', animation: 'breathe' as const },
      { id: 'closing', type: 'closing' as const, duration: 7, text: 'Well done.', guidance: 'Carry this calm with you.', animation: 'fade' as const },
    ],
  },
