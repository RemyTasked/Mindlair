...
const FLOWS = {
  'pre-meeting-focus': {
    ...
    steps: [
      { id: 'intro', type: 'intro' as const, duration: 25, text: "Let's take a few minutes to prepare.", guidance: "Find a comfortable position. Close your eyes if you'd like. You're about to step into an important moment. There is no rush.", animation: 'fade' as const },
      { id: 'breathing-1', type: 'breathing' as const, duration: 100, text: 'Box Breathing', guidance: 'Breathe in slowly for 8 counts. Hold gently for 8. Breathe out slowly for 8. Rest for 8. Let each breath be unhurried.', animation: 'breathe' as const },
      { id: 'body-scan', type: 'body-scan' as const, duration: 60, text: 'Quick Body Scan', guidance: 'Notice any tension in your shoulders. Your jaw. Your hands. Invite each area to soften and release. Take your time.', animation: 'pulse' as const },
      { id: 'breathing-2', type: 'breathing' as const, duration: 100, text: 'Continue Breathing', guidance: 'Another round of box breathing. In... Hold... Out... Hold... Let each breath deepen your calm.', animation: 'breathe' as const },
      { id: 'intention', type: 'visualization' as const, duration: 30, text: 'Set Your Intention', guidance: "What's your focus for this meeting? What do you want to bring to this conversation? Hold that intention clearly.", animation: 'expand' as const },
      { id: 'closing', type: 'closing' as const, duration: 15, text: "You're ready.", guidance: 'Take a final deep breath. Enter your meeting with presence and confidence.', animation: 'fade' as const },
    ],
  },
  'pre-presentation-power': {
    ...
    duration: 300, // Longer for proper preparation
    ...
    steps: [
      { id: 'intro', type: 'intro' as const, duration: 20, text: "Let's build your presence for this moment.", guidance: "Stand tall if you can. You have something valuable to share. Let's prepare together.", animation: 'expand' as const },
      { id: 'power-pose', type: 'movement' as const, duration: 60, text: 'Power Pose', guidance: 'Stand with feet shoulder-width apart, hands on hips or raised. Expand your body. Take up space. Feel your strength.', animation: 'expand' as const },
      { id: 'breathing', type: 'breathing' as const, duration: 70, text: 'Energizing Breath', guidance: 'Energizing breaths, but still calm. In for 6 counts... hold for 4... out for 6... hold for 2. Feel energy building.', animation: 'breathe' as const },
      { id: 'visualization', type: 'visualization' as const, duration: 60, text: 'See Your Success', guidance: "Picture yourself delivering with confidence. See the audience engaged. Feel their positive attention. You belong here.", animation: 'pulse' as const },
      { id: 'voice-warmup', type: 'movement' as const, duration: 50, text: 'Voice Warm-Up', guidance: 'Hum gently. Roll your shoulders. Loosen your jaw. Your voice is your instrument. Let it resonate.', animation: 'pulse' as const },
      { id: 'affirmation', type: 'affirmation' as const, duration: 30, text: 'I am prepared and capable.', guidance: 'Say to yourself: "I am prepared. I am capable. I have value to share."', animation: 'expand' as const },
      { id: 'closing', type: 'closing' as const, duration: 15, text: "Go share your brilliance.", guidance: "You've got this. Go with confidence.", animation: 'fade' as const },
    ],
  },
  'quick-reset': {
    id: 'quick-reset',
    ...
    duration: 200, // Longer for proper pacing
    ...
    steps: [
      { id: 'intro', type: 'intro' as const, duration: 15, text: "Let's do a quick reset.", guidance: 'Stand up if you can. Roll your shoulders back. Take a moment to arrive here.', animation: 'fade' as const },
      { id: 'shake-out', type: 'movement' as const, duration: 40, text: 'Shake It Out', guidance: 'Gently shake your hands. Your arms. Your shoulders. Release any tension from the last meeting. Let it go.', animation: 'pulse' as const },
      { id: 'breathing', type: 'breathing' as const, duration: 100, text: 'Cleansing Breaths', guidance: 'Deep breath in through your nose for 6 counts. Long, slow exhale through your mouth for 10 counts. Let everything go.', animation: 'breathe' as const },
      { id: 'mental-clear', type: 'visualization' as const, duration: 50, text: 'Clear Your Mind', guidance: "Imagine a gentle breeze clearing away thoughts. Each exhale releases what you no longer need. You're in the present now.", animation: 'expand' as const },
      { id: 'closing', type: 'closing' as const, duration: 20, text: 'Reset complete.', guidance: "Fresh start. You're ready for what's next.", animation: 'fade' as const },
    ],
  },
  'post-meeting-decompress': {
    ...
    duration: 220, // Longer for proper decompression
    ...
    steps: [
      { id: 'intro', type: 'intro' as const, duration: 15, text: "Let's release what just happened.", guidance: 'That meeting is over. Allow yourself to transition. There is no rush.', animation: 'fade' as const },
      { id: 'breathing-1', type: 'breathing' as const, duration: 75, text: 'Tension Release Breathing', guidance: 'Breathe in slowly for 6 counts... hold for 7... long exhale for 10 counts, releasing all tension.', animation: 'breathe' as const },
      { id: 'body-release', type: 'body-scan' as const, duration: 50, text: 'Release Physical Tension', guidance: 'Roll your shoulders back slowly... release your jaw... unclench your hands. Let each area soften.', animation: 'pulse' as const },
      { id: 'acknowledgment', type: 'visualization' as const, duration: 35, text: 'Acknowledge & Release', guidance: "Whatever happened, acknowledge it without judgment. It is done. Now, gently let it go.", animation: 'expand' as const },
      { id: 'breathing-2', type: 'breathing' as const, duration: 55, text: 'Final Release', guidance: 'One more deep breath. In slowly... hold... and release everything on a long, slow exhale.', animation: 'breathe' as const },
      { id: 'closing', type: 'closing' as const, duration: 20, text: "You're back in the present.", guidance: 'Take this clarity and calm with you.', animation: 'fade' as const },
    ],
  },
  'breathing': {
    id: 'breathing',
    ...
    shortName: 'Breathe',
    description: 'A gentle breathing exercise to calm your mind in an open meadow.',
    duration: 200, // Longer for truly meditative experience
    bestFor: ['Quick calm', 'Anxiety relief', 'Focus boost'],
    breathingPattern: 'box' as const,
    icon: '🌬️',
    benefits: ['Calm mind', 'Reduced anxiety', 'Better focus'],
    steps: [
      { id: 'intro', type: 'intro' as const, duration: 20, text: 'Welcome to your breathing garden.', guidance: 'Find a comfortable position. Close your eyes if you wish. Let your shoulders drop. Soften your jaw. There is no rush here.', animation: 'fade' as const },
      { id: 'breathing', type: 'breathing' as const, duration: 160, text: 'Box Breathing', guidance: 'Breathe in slowly for 8 counts. Hold gently for 8. Exhale slowly for 8. Rest for 8. Let each breath flow naturally. There is no hurry.', animation: 'breathe' as const },
      { id: 'closing', type: 'closing' as const, duration: 25, text: 'Beautiful.', guidance: 'Notice how you feel now. This calm is always available to you. Carry it with you into your next moment.', animation: 'fade' as const },
    ],
  },
  'difficult-conversation-prep': {
    ...
    duration: 300, // Longer for thorough preparation
    ...
    steps: [
      { id: 'intro', type: 'intro' as const, duration: 20, text: 'Prepare for this conversation with compassion.', guidance: "Difficult conversations are opportunities for growth. Let's approach this one grounded. There is no rush.", animation: 'fade' as const },
      { id: 'breathing-1', type: 'breathing' as const, duration: 85, text: 'Calming Breath', guidance: 'Extended exhale calms your nervous system. Breathe in for 6 counts... hold for 7... exhale slowly for 10 counts.', animation: 'breathe' as const },
      { id: 'perspective', type: 'visualization' as const, duration: 60, text: 'Perspective Taking', guidance: "Consider the other person's position. What might they be feeling? What do they need? Take time to truly consider this.", animation: 'pulse' as const },
      { id: 'breathing-2', type: 'breathing' as const, duration: 65, text: 'Continue Calming', guidance: 'In slowly for 6... hold for 7... out slowly for 10. Let calm deepen with each cycle.', animation: 'breathe' as const },
      { id: 'intention', type: 'visualization' as const, duration: 50, text: 'Communication Intention', guidance: 'What outcome would serve everyone? Hold that intention clearly. Speak from your values.', animation: 'expand' as const },
      { id: 'grounding', type: 'body-scan' as const, duration: 30, text: 'Ground in Values', guidance: 'Feel your feet on the ground. You are grounded in your integrity. You are prepared.', animation: 'pulse' as const },
      { id: 'closing', type: 'closing' as const, duration: 15, text: 'Enter with compassion.', guidance: 'You are ready. Go with confidence and kindness.', animation: 'fade' as const },
    ],
  },
  'end-of-day-transition': {
    ...
    duration: 300, // Longer for proper transition
    ...
    steps: [
      { id: 'intro', type: 'intro' as const, duration: 20, text: 'Time to close the work chapter.', guidance: 'The workday is complete. Honor what you accomplished. Take your time here.', animation: 'fade' as const },
      { id: 'breathing-1', type: 'breathing' as const, duration: 70, text: 'Transitional Breathing', guidance: 'Deep, slow breaths. In for 6 counts... hold for 7... out slowly for 10. Let the day begin to fade.', animation: 'breathe' as const },
      { id: 'acknowledgment', type: 'visualization' as const, duration: 60, text: 'Acknowledge Your Day', guidance: "What did you accomplish today? Give yourself credit without judgment. It is enough. You are enough.", animation: 'pulse' as const },
      { id: 'letting-go', type: 'visualization' as const, duration: 60, text: 'Let Go of Work', guidance: "Visualize gently closing a door. Work stays on the other side. You're stepping into personal time now.", animation: 'expand' as const },
      { id: 'breathing-2', type: 'breathing' as const, duration: 60, text: 'Calming Breath', guidance: 'In slowly for 6... hold for 7... out slowly for 10. Each breath releases more of the day.', animation: 'breathe' as const },
      { id: 'intention', type: 'visualization' as const, duration: 35, text: 'Evening Intention', guidance: 'What will make this evening meaningful? Hold that intention gently.', animation: 'expand' as const },
      { id: 'closing', type: 'closing' as const, duration: 20, text: 'Your evening begins now.', guidance: 'Be present for what matters. You have earned this rest.', animation: 'fade' as const },
    ],
  },
  'morning-intention': {
