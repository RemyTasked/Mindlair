...
xcrun safari-web-extension-converter safari/Resources \
  ...
  --app-name "Mindlayer" \
  --bundle-identifier com.mindlayer.safari-extension \
  --swift \
...
```bash
open safari/xcode/Mindlayer/Mindlayer.xcodeproj
```
...
1. Select the "Mindlayer" scheme
2. Build and run (Cmd+R)
3. Safari will launch with the extension available
4. Go to Safari → Settings → Extensions → Enable "Mindlayer"
