  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, padding: "24px 16px 100px" }}>
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        >
          <StanceIcon size={24} style={{ color: stanceColor }} />
          <div>
            <div style={{ color: stanceColor, fontWeight: 600, marginBottom: 2 }}>
            ...
            >
              <div style={{
                ...
                {post.author.avatarUrl ? (
                  ...
                  <User size={24} style={{ color: C.muted }} />
                )}
              </div>
              <div>
        ...
        >
          ...
          <AnimatePresence>
            {post.userReaction && post.reactionCounts && (
              ...
              >
                <div>
                  <div style={{ color: C.green, fontSize: 24, fontWeight: 600 }}>
                    {post.reactionCounts.agree || 0}
                  </div>
                  <div style={{ color: C.muted, fontSize: 12 }}>agree</div>
                </div>
                <div>
                  <div style={{ color: C.rose, fontSize: 24, fontWeight: 600 }}>
                    {post.reactionCounts.disagree || 0}
                  </div>
                  <div style={{ color: C.muted, fontSize: 12 }}>disagree</div>
                </div>
                <div>
                  <div style={{ color: C.accent, fontSize: 24, fontWeight: 600 }}>
                    {post.reactionCounts.complicated || 0}
                  </div>
                  <div style={{ color: C.muted, fontSize: 12 }}>complicated</div>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            {[
              ...
              { stance: "complicated", icon: HelpCircle, label: "It's Complicated", color: C.accent },
              ...
              return (
                ...
                >
                  <Icon size={18} style={{ color: isSelected ? color : C.muted }} />
                  <span style={{ 
