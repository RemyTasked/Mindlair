...
// ── Main component ─────────────────────────────────────────────
export default function MindlairYearWrapped() {
  ...
  const generateLink = useCallback(() => {
    setShareLink(`https://mindlair.app/fingerprint?tab=wrapped&demo=${Math.random().toString(36).slice(2, 8)}`);
  }, []);
