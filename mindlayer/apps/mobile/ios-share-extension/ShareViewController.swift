...
class ShareViewController: UIViewController {
    ...
    private let appGroupIdentifier = "group.app.mindlayer"
    private let urlScheme = "mindlayer://share"
    ...
    private func openMainApp(url: URL) {
        ...
        guard let openURL = URL(string: "mindlayer://") else { return }
    ...
    private func completeRequest(success: Bool) {
        DispatchQueue.main.async { [weak self] in
            if success {
                ...
                let error = NSError(domain: "app.mindlayer.share", code: 1, userInfo: nil)
